(() => {
  ...
  // extensions/remove-free-product/node_modules/react/cjs/react.development.js
  var require_react_development = __commonJS({
    "extensions/remove-free-product/node_modules/react/cjs/react.development.js"(exports) {
      "use strict";
      if (true) {
        (function() {
          "use strict";
  ...
  // extensions/remove-free-product/node_modules/react/index.js
  var require_react = __commonJS({
    "extensions/remove-free-product/node_modules/react/index.js"(exports, module) {
      "use strict";
      if (false) {
        module.exports = null;
      } else {
...
For more info, visit https://reactjs.org/link/mock-scheduler`);
  ...
  // extensions/remove-free-product/node_modules/react/cjs/react-jsx-runtime.development.js
  var require_react_jsx_runtime_development2 = __commonJS({
    "extensions/remove-free-product/node_modules/react/cjs/react-jsx-runtime.development.js"(exports) {
      "use strict";
      if (true) {
        (function() {
          "use strict";
  ...
  // extensions/remove-free-product/node_modules/react/jsx-runtime.js
  var require_jsx_runtime2 = __commonJS({
    "extensions/remove-free-product/node_modules/react/jsx-runtime.js"(exports, module) {
      "use strict";
      if (false) {
        module.exports = null;
      } else {
  ...
  // extensions/remove-free-product/node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/render.mjs
  ...
  // extensions/remove-free-product/node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/context.mjs
...
${errorInfo.componentStack}`);
  ...
  // extensions/remove-free-product/node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/components/Text/Text.mjs
  var Text2 = createRemoteReactComponent(Text);

  // extensions/remove-free-product/node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/hooks/api.mjs
  var import_react8 = __toESM(require_react(), 1);

  // extensions/remove-free-product/node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/errors.mjs
  ...
  // extensions/remove-free-product/node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/hooks/subscription.mjs
  ...
  // extensions/remove-free-product/node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/hooks/cart-lines.mjs
  ...
  // extensions/remove-free-product/node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/hooks/buyer-identity.mjs
  function useEmail() {
  ...
  // extensions/remove-free-product/src/Checkout.jsx
  ...
  function Extension() {
    ...
    const user = useEmail();
    const [subscriptionChecker, setSubscriptionChecker] = (0, import_react10.useState)(false);
    const [removedCheck, setRemovedCheck] = (0, import_react10.useState)(false);
    const [freeProductIds, setFreeProductIds] = (0, import_react10.useState)([]);
    function handleRemoveToCart(variantId) {
      return __async(this, null, function* () {
    ...
    function searchCustomerByEmail(email) {
      console.log(email);
      console.log(lines);
      const endpoint = " https://revival-customer-search-20c0e7f7ec2f.herokuapp.com/customerSearch";
      const data = {
        email
      };
    ...
    (0, import_react10.useEffect)(() => {
      ...
      lines.forEach((item) => {
        var _a, _b, _c, _d, _e;
        if ((item.merchandise.title == "30 Pack" || item.merchandise.title == "12 Pack") && ((_a = item.merchandise) == null ? void 0 : _a.sellingPlan)) {
          setSubscriptionChecker(true);
        }
        if (item.merchandise.title == "Kids Multi-Vitamin Squash" && ((_d = (_c = (_b = item.merchandise) == null ? void 0 : _b.selectedOptions[0]) == null ? void 0 : _c.value) == null ? void 0 : _d.includes("30 Pack")) && ((_e = item.merchandise) == null ? void 0 : _e.sellingPlan)) {
          setSubscriptionChecker(true);
        }
        if ((item.merchandise.title == "Steel Water Bottle" || item.merchandise.title == "Kids Steel Water Bottle") && item.cost.totalAmount.amount == 0) {
          let productId = [];
      ...
      function removeExtraProduct() {
        return __async(this, null, function* () {
          if (user == null ? void 0 : user.includes("@")) {
            const customers = yield searchCustomerByEmail(user);
            console.log("right before orders");
            console.log(customers);
            let subscriptionDetectionFlag = false;
            customers.forEach((item) => {
              var _a, _b;
              if (((_a = item.tags) == null ? void 0 : _a.includes("Subscription")) || ((_b = item.customer.tags) == null ? void 0 : _b.includes("free_product_redeemed"))) {
                subscriptionDetectionFlag = true;
              }
            });
            if (subscriptionDetectionFlag && freeProductIds.length != 0) {
              const processItemsSequentially = () => __async(this, null, function* () {
                for (const item of freeProductIds) {
                  yield handleAddToCart(item);
                }
              });
    ...
    return removedCheck ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Text2, { size: "medium", children: [
      " ",
      "Free product removed - It looks like you have previously claimed the free gift!"
    ] }) : null;
  }
})();
